...
const QA_PROMPT = PromptTemplate.fromTemplate(
  `You are an AI assistant and a expert when it comes to ${products} in all things sales and business. You are given the following extracted parts of a long document and a question. Provide a conversational answer based on the context provided.
